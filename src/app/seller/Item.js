  ...
  return ( 
    <div className="w-full h-full md:w-[300px] md:h-auto bg-yellow-400 p-4 border-l border-yellow-600 relative overflow-y-auto"> 
      ...
      <div 
        ...
        className="w-full h-[150px] bg-gray-300 rounded-md mb-4 overflow-hidden flex items-center justify-center cursor-pointer hover:brightness-95 relative" 
      > 
        {image ? ( 
          /* We use unoptimized here because the URL is a local blob, not a permanent URL */
          <Image 
            src={image} 
            alt="Preview" 
